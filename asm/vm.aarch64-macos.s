...
; %bb.4:
	...
	add	x24, x8, #40
	b	.L6
.L5:                                ;   in Loop: Header=BB62_6 Depth=1
	add	x23, x23, #1
	add	x24, x24, #16
	cmp	x21, x23
	b.eq	.L11
...
; %bb.16:
	...
	add	x27, x24, #40
	b	.L18
.L17:                               ;   in Loop: Header=BB62_18 Depth=1
	add	x26, x26, #1
	add	x27, x27, #16
	cmp	x25, x26
	b.eq	.L25
...
; %bb.26:
	...
	add	x24, x8, #40
	b	.L28
.L27:                               ;   in Loop: Header=BB62_28 Depth=1
	add	x23, x23, #1
	add	x24, x24, #16
	cmp	x21, x23
	b.eq	.L30
...
_vm_op_load_typed_fallback:             ; @vm_op_load_typed_fallback
; %bb.0:
	stp	x29, x30, [sp, #-16]!           ; 16-byte Folded Spill
	mov	x29, sp
	mov	x9, x1
...
_vm_op_set_typed_fallback:              ; @vm_op_set_typed_fallback
; %bb.0:
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
	add	x29, sp, #16
