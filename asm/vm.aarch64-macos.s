...
; %bb.0:
	...
	cbz	x1, .L30
; %bb.1:
	and	x16, x1, #0xfffffffffffffffe
	and	x16, x16, #0xfffe000000000003
	cbnz	x16, .L30
; %bb.2:
	mov	x0, #0                          ; =0x0
	and	x16, x1, #0x1fffffffffff8
	ldrb	w17, [x16]
	cmp	w17, #3
	b.eq	.L18
; %bb.3:
...
; %bb.10:                               ;   in Loop: Header=BB77_9 Depth=2
	...
	b.ne	.L9
	b	.L15
.L11:                               ;   in Loop: Header=BB77_7 Depth=1
	cmp	w17, w3
	b.ls	.L15
...
; %bb.0:
	...
	ldr	w3, [x0, #12]
	ldr	w0, [x1, #12]
	stp	x2, x15, [sp, #40]              ; 8-byte Folded Spill
	stp	x16, x17, [sp, #24]
	stp	x8, x0, [sp, #8]
Lloh30:
...
.L22:
	...
	add	x1, x1, #40
	mov	w2, w17
.L23:                               ; =>This Inner Loop Header: Depth=1
	ldr	x3, [x1, x0, lsl #3]
	cmp	x3, x8
	b.eq	.L16
