...
; %bb.0:
	...
	mov	x17, #-562949953421312          ; =0xfffe000000000000
	cmp	x1, x17
	b.lo	.L9
; %bb.1:
	mov	x0, #0                          ; =0x0
...
; %bb.6:
	ldr	x16, [x8, #24]
	ands	x16, x16, #0xfffffffffffffff8
	b.eq	.L37
; %bb.7:
	ldr	x17, [x8, #16]
	ldur	x17, [x17, #12]
...
.L7:
	ldr	x16, [x16, #16]
	str	x8, [x2]
	mov	x17, #-562949953421313          ; =0xfffdffffffffffff
	cmp	x1, x17
	b.ls	.L13
; %bb.8:
	cbz	x8, .L26
...
; %bb.10:                               ;   in Loop: Header=BB71_9 Depth=2
	...
	b.ne	.L9
	b	.L15
.L11:                               ;   in Loop: Header=BB71_7 Depth=1
	cmp	w17, w3
	b.ls	.L15
