...
_vm_op_LoadMem:                         ; @vm_op_LoadMem
; %bb.0:
	add	x20, x20, #4
	b	_vm_op_loadmem_miss
                                        ; -- End function
	.p2align	5                               ; -- Begin function vm_op_LoadMemC
_vm_op_LoadMemC:                        ; @vm_op_LoadMemC
; %bb.0:
	and	x8, x0, #0xff
	ldr	x8, [x21, x8, lsl #3]
	sub	x9, x8, #8
...
_vm_op_SetMem:                          ; @vm_op_SetMem
; %bb.0:
	add	x20, x20, #4
	b	_vm_op_setmem_miss
                                        ; -- End function
	.p2align	5                               ; -- Begin function vm_op_SetMemC
_vm_op_SetMemC:                         ; @vm_op_SetMemC
; %bb.0:
	and	x8, x0, #0xff
	ldr	x8, [x21, x8, lsl #3]
	sub	x9, x8, #8
...
_vm_op_LoadSlot:                        ; @vm_op_LoadSlot
; %bb.0:
	and	w9, w0, #0xff
	mov	x8, x20
	ldr	w11, [x8], #4
...
.L7:
	mov	x20, x8
	b	_vm_op_load_by_type_fallback
                                        ; -- End function
	.p2align	5                               ; -- Begin function vm_op_SetSlot
_vm_op_SetSlot:                         ; @vm_op_SetSlot
; %bb.0:
	and	w9, w0, #0xff
	mov	x8, x20
	ldr	w11, [x8], #4
...
; %bb.0:
	add	x20, x20, #8
	b	_vm_op_invoke_miss
                                        ; -- End function
	.p2align	5                               ; -- Begin function vm_op_InvokeC
_vm_op_InvokeC:                         ; @vm_op_InvokeC
; %bb.0:
	and	x8, x0, #0xff
	ldr	x8, [x21, x8, lsl #3]
	sub	x9, x8, #8
...
Lloh19:
	...
	.loh AdrpAdd	Lloh18, Lloh19
                                        ; -- End function
	.p2align	5                               ; -- Begin function vm_op_loadmem_miss
_vm_op_loadmem_miss:                    ; @vm_op_loadmem_miss
; %bb.0:
	sub	sp, sp, #48
...
.L5:
	...
	b	_nomember
                                        ; -- End function
	.p2align	2                               ; -- Begin function find_member_by_selector
_find_member_by_selector:               ; @find_member_by_selector
; %bb.0:
...
; %bb.12:
	...
	add	x26, x23, #48
	b	.L14
.L13:                               ;   in Loop: Header=BB65_14 Depth=1
	add	x25, x25, #1
	add	x26, x26, #16
	cmp	x24, x25
	b.eq	.L33
...
.L18:
	...
	add	x23, x8, #48
	b	.L20
.L19:                               ;   in Loop: Header=BB65_20 Depth=1
	add	x26, x26, #1
	add	x23, x23, #16
	cmp	x24, x26
	b.eq	.L44
...
.L40:
	...
	sub	x17, x16, #4
	add	x8, x8, #32
	ands	x16, x0, #0xfffffffffffffff8
	str	x17, [x19]
	stp	x16, x8, [x19, #8]
	b.eq	.L44
; %bb.41:
...
Lloh21:
	...
	.loh AdrpAdd	Lloh20, Lloh21
                                        ; -- End function
	.p2align	2                               ; -- Begin function cache_member
_cache_member:                          ; @cache_member
; %bb.0:
	cmp	w3, #255
	b.hi	.L3
; %bb.1:
...
.L3:
	ret
                                        ; -- End function
	.p2align	5                               ; -- Begin function vm_op_setmem_miss
_vm_op_setmem_miss:                     ; @vm_op_setmem_miss
; %bb.0:
	sub	sp, sp, #48
	stp	x29, x30, [sp, #32]             ; 16-byte Folded Spill
	add	x29, sp, #32
...
.L7:
	...
	b	.L3
                                        ; -- End function
	.p2align	2                               ; -- Begin function find_field_by_selector
_find_field_by_selector:                ; @find_field_by_selector
; %bb.0:
	mov	x8, x0
	mov	x0, #0                          ; =0x0
	cbz	x8, .L28
...
; %bb.5:
	...
	sub	x8, x8, #4
	add	x16, x16, #32
	ands	x17, x17, #0xfffffffffffffff8
	stp	x8, x17, [x19]
	str	x16, [x19, #16]
	cset	w17, eq
	b	.L8
...
; %bb.16:
	...
	add	x25, x8, #48
	b	.L18
.L17:                               ;   in Loop: Header=BB69_18 Depth=1
	add	x24, x24, #1
	add	x25, x25, #16
	cmp	x23, x24
	b.eq	.L26
...
_vm_op_load_by_type_fallback:           ; @vm_op_load_by_type_fallback
; %bb.0:
	stp	x29, x30, [sp, #-16]!           ; 16-byte Folded Spill
	mov	x29, sp
	and	w8, w0, #0xff
...
; %bb.9:
	...
	b	_nomember
                                        ; -- End function
	.p2align	2                               ; -- Begin function find_field_slow_forward
_find_field_slow_forward:               ; @find_field_slow_forward
; %bb.0:
	mov	x4, #0                          ; =0x0
	b	_find_field_slow
                                        ; -- End function
	.p2align	2                               ; -- Begin function find_field_slow
_find_field_slow:                       ; @find_field_slow
; %bb.0:
...
.L6:
	...
	add	x19, x23, #32
	sub	x23, x8, #4
	and	x24, x16, #0xfffffffffffffff8
	cbz	x20, .L8
.L7:
	str	x24, [x20]
.L8:
...
; %bb.11:
	...
	add	x28, x25, #48
	b	.L13
.L12:                               ;   in Loop: Header=BB73_13 Depth=1
	add	x27, x27, #1
	add	x28, x28, #16
	cmp	x26, x27
	b.eq	.L24
...
.L27:
	...
	add	x25, x8, #48
	b	.L29
.L28:                               ;   in Loop: Header=BB73_29 Depth=1
	add	x20, x20, #1
	add	x25, x25, #16
	cmp	x24, x20
	b.eq	.L25
...
_vm_op_set_by_type_fallback:            ; @vm_op_set_by_type_fallback
; %bb.0:
	sub	sp, sp, #32
	stp	x29, x30, [sp, #16]             ; 16-byte Folded Spill
	add	x29, sp, #16
	...
	ldur	w11, [x20, #-4]
	lsr	x11, x11, #8
	ldr	x12, [x21, w8, uxtw #3]
	and	x8, x12, #0xfffffffffffffffe
	and	x8, x8, #0xfffe000000000003
	cmp	x12, #0
	ccmp	x8, #0, #0, ne
	b.ne	.L12
...
; %bb.8:                                ;   in Loop: Header=BB77_7 Depth=1
	...
	b	.L10
.L9:                                ;   in Loop: Header=BB77_10 Depth=2
	add	x27, x27, #1
	add	x26, x26, #16
	cmp	x28, x27
	b.eq	.L16
.L10:                               ;   Parent Loop BB77_7 Depth=1
...
Lloh39:
	...
	.loh AdrpAdd	Lloh38, Lloh39
                                        ; -- End function
	.p2align	5                               ; -- Begin function vm_op_invoke_miss
_vm_op_invoke_miss:                     ; @vm_op_invoke_miss
; %bb.0:
	sub	sp, sp, #48
	stp	x29, x30, [sp, #32]             ; 16-byte Folded Spill
	add	x29, sp, #32
...
; %bb.11:
	...
	add	x27, x24, #48
	b	.L13
.L12:                               ;   in Loop: Header=BB85_13 Depth=1
	add	x26, x26, #1
	add	x27, x27, #16
	cmp	x25, x26
	b.eq	.L19
...
.L20:
	...
	add	x24, x8, #48
	b	.L22
.L21:                               ;   in Loop: Header=BB85_22 Depth=1
	add	x23, x23, #1
	add	x24, x24, #16
	cmp	x25, x23
	b.eq	.L24
...
_dispatch:
	...
	.quad	_vm_op_LoadMem
	.quad	_vm_op_LoadMemC
	.quad	_vm_op_SetMem
	.quad	_vm_op_SetMemC
	.quad	_vm_op_LoadSlot
	.quad	_vm_op_SetSlot
	.quad	_vm_op_LoadInd
	.quad	_vm_op_SetInd
	.quad	_vm_op_View
