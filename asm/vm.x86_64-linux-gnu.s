...
# %bb.0:
	...
	subq	$32, %rsp
	movq	%rsi, %rbx
	movabsq	$-562949953421310, %rsi         # imm = 0xFFFE000000000002
	xorps	%xmm0, %xmm0
	movups	%xmm0, (%rdx)
	movq	$0, 16(%rdx)
	leaq	-3(%rsi), %r11
...
# %bb.0:
	...
	je	.L31
# %bb.1:
	movabsq	$-562949953421313, %r9          # imm = 0xFFFDFFFFFFFFFFFF
	leaq	3(%r9), %r11
	andq	%rdi, %r11
	jne	.L31
# %bb.2:
...
.L26:
	...
	jmp	.L28
	.p2align	4
.L27:                              #   in Loop: Header=BB73_28 Depth=1
	addq	$1, %r14
	addq	$16, %r12
	cmpq	%r14, %r15
	je	.L35
...
# %bb.12:
	...
	jmp	.L14
	.p2align	4
.L13:                              #   in Loop: Header=BB85_14 Depth=1
	addq	$1, %rbx
	addq	$16, %r13
	cmpq	%rbx, %r14
	je	.L21
...
.L22:
	...
	jmp	.L24
	.p2align	4
.L23:                              #   in Loop: Header=BB85_24 Depth=1
	addq	$1, %r14
	addq	$16, %r13
	cmpq	%r14, %rbx
	je	.L33
